...
- [x] 16. 实现 IDE 集成功能
  - [x] 16.1 实现 Cursor 命令安装
    - 创建 InstallCursorCommandHandler 类
    - 实现 .cursor/commands/ 目录创建和管理
    - 生成标准化的 Cursor 命令 Markdown 文件
    - 支持自定义安装目录和示例包含选项
    - 添加目录验证和 --force 选项支持
    - _需求: 12.1, 12.2, 12.3, 12.4, 12.5_

  - [ ]* 16.2 为 Cursor 命令安装编写属性测试
    - **属性 17: Cursor 命令安装完整性**
    - **验证: 需求 12.1, 12.2, 12.3**

  - [x] 16.3 实现 Claude 技能安装
    - 创建 InstallClaudeSkillHandler 类
    - 实现个人和项目级技能目录管理
    - 生成包含 YAML frontmatter 的 SKILL.md 文件
    - 支持可选的示例和参考文档生成
    - 添加目录验证和 --force 选项支持
    - _需求: 13.1, 13.2, 13.3, 13.4, 13.5_

  - [ ]* 16.4 为 Claude 技能安装编写属性测试
    - **属性 18: Claude 技能安装完整性**
    - **验证: 需求 13.1, 13.2, 13.3**

  - [ ]* 16.5 为 IDE 集成文件格式编写属性测试
    - **属性 19: IDE 集成文件格式正确性**
    - **验证: 需求 12.4, 13.4, 14.1**

  - [ ]* 16.6 为 IDE 集成目录结构编写属性测试
    - **属性 20: IDE 集成目录结构**
    - **验证: 需求 12.5, 13.5, 14.2**

  - [x] 16.7 添加 CLI 接口支持
    - 在 CLIInterface 中添加 install-cursor-command 和 install-claude-skill 命令
    - 实现参数解析和验证
    - 添加帮助文档和使用示例
    - 添加 --force 参数支持
    - _需求: 14.3, 14.4_
